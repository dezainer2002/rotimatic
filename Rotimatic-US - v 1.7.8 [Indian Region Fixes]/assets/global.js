...
async function requireOnce( file, functionName, args = '' ) {
  try {
    ...
    console.log( `ERROR requireOnce`, err.message );
  }
}
...
function thousands_separators ( num ) {
  try {
    ...
    console.log( `ERROR thousands_separators`, err.message );
  }
}
...
function productAddedInCart( title, type, body ) {
  try {
    ...
    console.log( `ERROR productAddedInCart`, err.message );
  }
}
...
$( document )
  .on('click', '.notification .notification_item_ ._close_', function( e ) {
    try {
      ...
      console.log( `ERROR .notification .notification_item_ ._close_`, err.message );
    }
  });
