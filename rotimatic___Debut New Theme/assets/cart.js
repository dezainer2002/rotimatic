...
.on('change', '.cart__row .cart__quantity-td .cart__qty .cart__qty-input', function( e ) {
  try {
    setTimeout(() => {
      if ( onceBuy != undefined ) {
        $( `tr.cart__row[data-cart-item-url="${ onceBuy }"] .cart__quantity-td .cart__qty .cart__qty-input` ).attr( 'readonly', 'true' );
      }
    }, 1500);
