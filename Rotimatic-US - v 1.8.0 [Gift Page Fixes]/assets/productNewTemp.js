...
async function getUserCountry() {
  try {
    ...
    const countries_              =   ["United States","Canada","Denmark","Norway","Sweden","Netherlands","France","Germany","United Arab Emirates","Saudi Arabia","Bahrain","Kuwait","Oman","Qatar","Singapore","United Kingdom","Ireland","Hong Kong","Australia","New Zealand"];
