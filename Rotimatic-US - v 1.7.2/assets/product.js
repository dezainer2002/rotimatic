...
$( document )
  ...
  .on('click', '.faq-tabs .tab-title', function( e ) {
    try {
      e.stopImmediatePropagation();
      ...
      console.log ( 'ERROR .faq-tabs .tab-title', err.message );
    }
  })
  ...
  .on('click', '.thumbnails-wrapper .product-single__thumbnails .product-single__thumbnails-item .product-single__thumbnail', function( e ) {
    try {
      e.stopImmediatePropagation();
      e.preventDefault();

      const getImgSrc   =   $( this ).attr( 'href' );

      console.log ( 'getImgSrc', getImgSrc );

      $( `.product-single__media.product-single__media--has-thumbnails .feature-row__image` ).attr({
        'data-widths'       :   '',
        'data-aspectratio'  :   '',
        'data-sizes'        :   '',
        'data-srcset'       :   '',
      ...
      console.log ( 'ERROR .thumbnails-wrapper .product-single__thumbnails .product-single__thumbnails-item .product-single__thumbnail', err.message );
    }
  })
;
